...
class UsersImport extends Import implements ToModel, WithStartRow, WithHeadingRow, WithMultipleSheets, WithEvents, WithMapping, WithLimit, WithBatchInserts, WithValidation, SkipsOnFailure, SkipsOnError
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            '*.fathers_identity_type' => 'required_with:*.fathers_identity_number|in:NIC,BC',
            '*.fathers_identity_number' => 'nullable|identity:fathers_identity_type',
            ...
            '*.mothers_identity_type' => "required_with:*.mothers_identity_number|in:NIC,BC",
            ...
            '*.guardians_identity_type' => 'required_with:*.guardians_identity_number|in:NIC,BC',
