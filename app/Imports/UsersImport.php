...
//                   $allSubjects = array_unique($allSubjects,SORT_REGULAR);
    ...
    public function rules(): array {
        ...
        return [
            ...
            '*.fathers_full_name' => 'sometime|regex:/^[\pL\s\-]+$/u',
            ...
            '*.mothers_full_name' => 'sometime|regex:/^[\pL\s\-]+$/u',
            ...
            '*.guardians_full_name' => 'required_without_all:*.fathers_full_name,*.mothers_full_name|regex:/^[\pL\s\-]+$/u',
